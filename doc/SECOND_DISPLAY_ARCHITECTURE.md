...
Ниже зафиксированы **причины уровня «архитектура + железо»**, без обязательного кода-фикса. Симптомы совпадают с полевым кейсом: на экране во рту видна **системная** картинка (как на 0x3C), затем «рот» гаснет и **в шине пропадает адрес 0x3D**.
